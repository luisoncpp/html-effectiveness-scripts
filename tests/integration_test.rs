...
fn code_map_markdown_renders_component_and_no_raw_yaml() {
    ...
    assert!(html.contains("Initialization"));
    assert!(html.contains(r#"data-card="main""#));
    assert!(html.contains(r#"data-card="createServices""#));

    // Anchor tokens and arrows
    assert!(html.contains(r#"data-anchor="main.startup""#));
    assert!(html.contains(r#"data-from="startup.createServices""#));
    assert!(html.contains(r#"data-to="createServices""#));
