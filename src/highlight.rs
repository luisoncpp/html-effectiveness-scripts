...
const KW_C_LIKE: &[&str] = &[
    "if", "else", "for", "while", "return", "break", "continue", "new", "in",
    "of", "do", "switch", "case", "default", "try", "catch", "finally",
    "throw", "typeof", "instanceof", "void", "delete", "yield", "class",
    "extends", "super", "this", "import", "export", "from", "as", "async",
    "await", "static", "function", "let", "const", "var", "interface",
    "implements", "enum", "type", "namespace", "declare", "readonly",
    "public", "private", "protected", "abstract", "null", "undefined",
    "true", "false",
];

const KW_RUST: &[&str] = &[
    "fn", "let", "mut", "pub", "use", "mod", "crate", "impl", "trait",
    "struct", "enum", "match", "if", "else", "for", "while", "loop",
    "return", "break", "continue", "ref", "move", "async", "await", "dyn",
    "where", "unsafe", "as", "in", "self", "Self", "super", "const",
    "static", "type", "true", "false", "Some", "None", "Ok", "Err",
];

const KW_PYTHON: &[&str] = &[
    "def", "class", "if", "elif", "else", "for", "while", "return", "break",
    "continue", "import", "from", "as", "with", "try", "except", "finally",
    "raise", "pass", "lambda", "global", "nonlocal", "yield", "async",
    "await", "in", "is", "not", "and", "or", "del", "assert", "match",
    "case", "True", "False", "None", "self",
];
